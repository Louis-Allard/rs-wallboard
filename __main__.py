...
#Linkedin
l_pic    = Label(frame2, image=l_logo, bg=bgcolor).pack()
l_label1 = Label(frame2, text="Nombre de followers:", bg=bgcolor, fg='black',  font=("arial italic", 18)).pack()
l_data1  = Label(frame2, text=followed_by, fg='black', bg=bgcolor, font=("arial italic", 16)).pack()
l_label2 = Label(frame2, text="Nombre de follow:", bg=bgcolor, fg='black', font=("arial italic", 18)).pack()
l_data2  = Label(frame2, text=follow, fg='black', bg=bgcolor, font=("arial italic", 16)).pack()
