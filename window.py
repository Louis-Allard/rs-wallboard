...
Label(win, image=t_logo).pack(anchor="nw", padx=50, pady=5)

t_label1= Label(win, text="Nombre de followers:", fg='black',  font=("arial italic", 18)).pack(anchor='nw', padx=5, pady=5)
t_data1 = Label(win, text=fo_user, fg='black', font=("arial italic", 16)).pack(anchor='nw', padx=80)
t_label2 = Label(win, text="Nombre de follow:", fg='black', font=("arial italic", 16)).pack(anchor='nw', padx=5)
t_data2 = Label(win, text=fr_user, fg='black', font=("arial italic", 16)).pack(anchor='nw', padx=80)
