...
t_pic = Label(win, image=t_logo, bg='white').pack(anchor="nw", padx=50, pady=5)
...
i_pic = Label(win, image=i_logo, bg='white').pack(anchor="ne", padx=100,pady=5)

i_label1 = Label(win, text="Nombre de followers:", bg='white', fg='black',  font=("arial italic", 18)).pack(anchor='ne', padx=5, pady=5)
i_data1 = Label(win, text=followed_by, fg='black', bg='white', font=("arial italic", 16)).pack(anchor='ne')
i_label2 = Label(win, text="Nombre de follow:", bg='white', fg='black', font=("arial italic", 18)).pack(anchor='ne', padx=5)
i_data2 = Label(win, text=follow, fg='black', bg='white', font=("arial italic", 16)).pack(anchor='ne')
